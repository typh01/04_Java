...
public class Main1 {
	public static void main(String[] args) {
		...
		/* 2. 익명 내부 클래스 이용 */
		// 구현체 CalculatorImpl() 없이 익명함수로 처리 (1회용)
...
//		Calculator calc5 = (a, b) -> a*a + b*b*b;
		...
		// 람다는 추상메서드를 단! 1개만 가진 함수형 인터페이스 필요 (@FunctionalInterface)로 검사
		// 1. 인터페이스 구현 
		// 2. 익명클래스 내부에 함수 오버라이딩 
		// 3. 메서드 하나만 오버라이딩 하는 형식으로 표현
