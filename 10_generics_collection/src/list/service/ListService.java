...
public class ListService {
	...
	/* [Collectioni Framework]
	 *  - Java에서 제공하는 자료구조 모음
	 *  - java.util 패키지에 존재
	 *  
	 * [Collectioni Framework 특징] 
	 * 1. 크기 제한 X (알아서 늘거나 줄어듬)
