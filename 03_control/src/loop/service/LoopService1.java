...
//		for(초기식 ; 조건식 ; 증감식) {
//			// 조선식이 true 인 경우 반복 수행할 코드
//		}
		
		// 초기식 : for 문에서 사용할 지역 변수 선언
		// -> 대부분 for 문 제어를 위한 변수를 선언
		
		// 조건식 : 결과가 true/false 가 나오는 식
	...
	public void method2() {
		...
		// for 문 초기식, 조건식, 증감식 다르게
		// 987654321 출력하기
		for(int i=0 ; i<9 ; i++) {
			System.out.print(9-i); // 은근 자주 씀 눈에 익혀두자
		}
	}
	 ...
	 * <ul>
	 *  <li>입력 1이 입력 2보다 작은 경우 : 1234~ 증가하며 출력</li>
	...
	public void method6() {
		...
		System.out.printf("%d의 개수 : %d / 합계 : %d", num, count, sum);
