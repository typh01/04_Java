...
import section03.dto.PTHCalculator;
import section03.dto.PTHCalculator2;
...
//		Calculator calc = new PTHCalculator();
		 ...
		 *     -> 유지 보수성 향상!!
		 */
//		Calculator calc = new PTHCalculator2();
		...
		System.out.println(calc.multi(333333, 444444));
