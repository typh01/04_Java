...
//		}
	...
	public void test1() {
		...
		printObject(parent); // Object 의 자식 타입인 Parent 전달 가능
		printObject(child); // Object 의 후손 타입인 Child 전달 가능
	...
	public void test2() {
		...
		// o1, o2는 업캐스팅 상태
		Object o1 = getInstance(1)/* new Child */; // Child 객체 반환
