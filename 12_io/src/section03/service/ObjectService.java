...
public class ObjectService {
	...
	public void outputMember() {
		...
		ObjectOutputStream oos = null; // 객체 출력 보조 스트림 (객체를 통째로 보조 출력)
		...
		try {
			...
			// 파일 출력 기반 스트림 객체 생성
			fos = new FileOutputStream("io_test/byte/Member.bin");// binary의 약자
	...
	public void outputMemberList() {
		...
		try {
			...
			memberList.add(new Member("member05", "pass05", "유리"));
			memberList.add(new Member("member06", "pass06", "수지"));
			memberList.add(new Member("member07", "pass07", "짱아"));
